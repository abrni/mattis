...
pub const ZOBRIST_PIECE_KEYS:      [[u64; 12]; 64] = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/zobrist_piece_keys")) };
pub const ZOBRIST_COLOR_KEY:       u64             = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/zobrist_color_key")) };
pub const ZOBRIST_CASTLE_KEYS:     [u64; 16]       = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/zobrist_castle_keys")) };
pub const ZOBRIST_EN_PASSANT_KEYS: [u64; 64]       = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/zobrist_en_passant_keys")) };
...
pub const ROOK_MAGIC_BIT_COUNT:    [u32; 64]       = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/rook_magic_bit_count")) };
pub const BISHOP_MAGIC_BIT_COUNT:  [u32; 64]       = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/bishop_magic_bit_count")) };
pub const ROOK_MAGIC_MASKS:        [BitBoard; 64]  = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/rook_magic_masks")) };
pub const BISHOP_MAGIC_MASKS:      [BitBoard; 64]  = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/bishop_magic_masks")) };
pub const ROOK_MAGICS:             [u64; 64]       = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/rook_magics")) };
pub const BISHOP_MAGICS:           [u64; 64]       = unsafe { std::mem::transmute(*include_bytes!("../_static_tables/bishop_magics")) };